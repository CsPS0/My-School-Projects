...
titleEl.className = "font-semibold uppercase text-xl text-center text-red-700 py-4";
...
function createToppings() {
    ...
    for (let topping of getToppings()) {
            ...
            liEL.className = "px-4 py-2 uppercase border border-red-700 text-red-700 hover:bg-red-700 hover:text-red-100 cursor-pointer transition-colors";
            ulEl.append(liEL);
        }
